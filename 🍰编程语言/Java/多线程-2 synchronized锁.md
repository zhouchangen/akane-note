...
![image](H:/akane-note/🍰编程语言/Java/images/java31.png)

![image.png](H:/akane-note/🍰编程语言/Java/images/java32.png)
...
2. 第一个线程访问，markword 记录这个线程ID （偏向锁），如果第二次还是这个线程，就不用加锁
3. 如果线程争用：锁升级为轻量级锁， 自旋锁
...
![image.png](H:/akane-note/🍰编程语言/Java/images/java33.png)
...
![image.png](H:/akane-note/🍰编程语言/Java/images/java34.png)
...
![image.png](H:/akane-note/🍰编程语言/Java/images/java35.png)
